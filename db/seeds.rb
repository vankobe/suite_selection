...
ProductType.create({:category_id => 1, :name => "コーティング"})
...
ProductType.create({:category_id => 3, :name => "マドレーヌ・フィナンシェ"})
...
ProductCategory.create({:name => "コンフィチュール"})
ProductType.create({:category_id => 9, :name => "コンフィチュール"})
