class ProductContent < ActiveRecord::Base
  attr_accessible :category_id, :flavor_name, :product_id, :quantity, :type_id, :name
  belongs_to :product
  belongs_to :category, :class_name => "ProductCategory"
  belongs_to :type, :class_name => "ProductType"

  validates :category_id, :flavor_name, :product_id, :quantity, :type_id, presence: true, if: :published?
